...
/*
 * Profile screen (Step 8A). For the anonymous sessions that exist today it
 * shows the session identity and a working "End session" action. The
 * highlights section renders the production layout — count, revoke with a
 * confirmation step — fed by real data once Steps 6/7 land.
 */
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card className="flex flex-col gap-3">
          ...
          <p className="text-sm text-ink-soft">
            Highlight import needs a YouVersion account (Steps 6–7). Sign in to
            bring your highlights into Round.
          </p>
          <Divider />
          {confirmingRevoke ? (
