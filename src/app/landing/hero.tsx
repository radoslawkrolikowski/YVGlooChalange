...
import { SignInWithYouVersion } from "./youversion-auth-button";
    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-4">
          <SignInWithYouVersion appKey={appKey} />
          <button
            type="button"
            onClick={enter}
            disabled={busy}
      ...
      >
        ...
        {verse && (
          <figure
            className="absolute inset-x-8 bottom-16 rounded-3xl px-6 py-4 text-center md:bottom-24 md:left-[26%] md:right-[calc(2.5rem+10%)] md:-translate-x-12"
            style={{
              background:
